# coding=utf-8
# 本程式目的為抓取道瓊指數ETF：DIA及其30支成分股每日的股價資料
...
# 假如沒有這個資料夾就新增
if not os.path.exists("DIA_stocks"):
    os.mkdir("DIA_stocks")

"""
必須修改網頁中的標頭，來下載想要的日期，以下為網址註解：
s = 股票代碼，定義在DIA_list.csv裡面，要改的是csv
a = fromMonth-1
...
global f
# 讀取成分股列表
f = open('DIA_stocks/DIA_list.csv', 'r')
# 讀取有幾列，代表有幾支成分股
...
for ticker in file_content:
    ...
    try:
        ...
        # 股價寫入新檔
        history_file = open("DIA_stocks/" + ticker + ".csv", "w")

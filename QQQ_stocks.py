# coding=utf-8
# 本程式目的為抓取那斯達克指數ETF：QQQ及其107支成分股每日的股價資料
...
# 假如沒有這個資料夾就新增
if not os.path.exists("QQQ_stocks"):
    os.mkdir("QQQ_stocks")

"""
必須修改網頁中的標頭，來下載想要的日期，以下為網址註解：
s = 股票代碼，定義在QQQ_list.csv裡面，要改的是csv
a = fromMonth-1
...
global f
# 讀取成分股列表
f = open('QQQ_stocks/QQQ_list.csv', 'r')
# 讀取有幾列，代表有幾支成分股
...
for ticker in file_content:
    ...
    try:
        ...
        # 股價寫入新檔
        history_file = open("QQQ_stocks/" + ticker + ".csv", "w")
